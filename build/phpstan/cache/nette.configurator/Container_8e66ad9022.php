...
// source: phar:///var/www/html/library-rossana-errico/vendor/phpstan/phpstan/phpstan.phar/conf/config.levelmax.neon
...
class Container_8e66ad9022 extends _PHPStan_11268e5ee\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService049(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_8e66ad9022 $container)
			{
	...
	public function createService063(): PHPStan\DependencyInjection\DerivativeContainerFactory
	{
		return new PHPStan\DependencyInjection\DerivativeContainerFactory(
			...
			[
				'phar:///var/www/html/library-rossana-errico/vendor/phpstan/phpstan/phpstan.phar/conf/config.levelmax.neon',
	...
	public function createServiceContainer(): Container_8e66ad9022
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'allConfigFiles' => [
				...
				'phar:///var/www/html/library-rossana-errico/vendor/phpstan/phpstan/phpstan.phar/conf/config.levelmax.neon',
				'phar:///var/www/html/library-rossana-errico/vendor/phpstan/phpstan/phpstan.phar/conf/config.level9.neon',
				'phar:///var/www/html/library-rossana-errico/vendor/phpstan/phpstan/phpstan.phar/conf/config.level8.neon',
				'phar:///var/www/html/library-rossana-errico/vendor/phpstan/phpstan/phpstan.phar/conf/config.level7.neon',
				'phar:///var/www/html/library-rossana-errico/vendor/phpstan/phpstan/phpstan.phar/conf/config.level6.neon',
