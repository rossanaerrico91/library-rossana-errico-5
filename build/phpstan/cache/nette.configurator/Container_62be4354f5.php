...
// source: phar:///var/www/html/library-rossana-errico/vendor/phpstan/phpstan/phpstan.phar/conf/config.level5.neon
...
class Container_62be4354f5 extends _PHPStan_11268e5ee\Nette\DI\Container
{
	protected $tags = [
	...
	protected $wiring = [
		...
		'Larastan\Larastan\Rules\UselessConstructs\NoUselessWithFunctionCallsRule' => [['rules.163']],
		'Larastan\Larastan\Rules\UselessConstructs\NoUselessValueFunctionCallsRule' => [['rules.164']],
		'Larastan\Larastan\Rules\DeferrableServiceProviderMissingProvidesRule' => [['rules.165']],
		'Larastan\Larastan\Rules\ConsoleCommand\UndefinedArgumentOrOptionRule' => [['rules.166']],
	...
	public function createService049(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_62be4354f5 $container)
			{
	...
	public function createService063(): PHPStan\DependencyInjection\DerivativeContainerFactory
	{
		return new PHPStan\DependencyInjection\DerivativeContainerFactory(
			...
			[
				'phar:///var/www/html/library-rossana-errico/vendor/phpstan/phpstan/phpstan.phar/conf/config.level5.neon',
	...
	{
		return new Larastan\Larastan\Methods\BuilderHelper($this->getService('reflectionProvider'), false, $this->getService('0404'));
	}
	...
	public function createServiceContainer(): Container_62be4354f5
	{
		return $this;
	}
	...
	public function createServiceRules__163(): Larastan\Larastan\Rules\UselessConstructs\NoUselessWithFunctionCallsRule
	{
		return new Larastan\Larastan\Rules\UselessConstructs\NoUselessWithFunctionCallsRule;
	}


	public function createServiceRules__164(): Larastan\Larastan\Rules\UselessConstructs\NoUselessValueFunctionCallsRule
	{
		return new Larastan\Larastan\Rules\UselessConstructs\NoUselessValueFunctionCallsRule;
	}


	public function createServiceRules__165(): Larastan\Larastan\Rules\DeferrableServiceProviderMissingProvidesRule
	{
		return new Larastan\Larastan\Rules\DeferrableServiceProviderMissingProvidesRule;
	}


	public function createServiceRules__166(): Larastan\Larastan\Rules\ConsoleCommand\UndefinedArgumentOrOptionRule
	{
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'allConfigFiles' => [
				...
				'phar:///var/www/html/library-rossana-errico/vendor/phpstan/phpstan/phpstan.phar/conf/config.level5.neon',
				'phar:///var/www/html/library-rossana-errico/vendor/phpstan/phpstan/phpstan.phar/conf/config.level4.neon',
